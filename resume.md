...
## 職務要約
2019年10月にフリーランスエンジニアとして独立し、以来7年近くにわたって複数のWebサービスの開発・運用に携わっている。
...
#### 受発注管理システム / Web請求システム (2019年10月～2020年10月)
`チーム規模` 2〜8人、エンジニア1〜3人

`担当業務` 要件定義、設計、実装、テスト、運用保守

`使用技術` Ruby on Rails、RSpec、JavaScript、Docker、MySQL、CircleCI、Capistrano、VPS

`コメント` フリーランス初期に、受発注管理システムの新規構築(要件定義から一人で担当)と、ガス会社向けWeb請求システムの設計・実装(3社分)に携わった。いずれもITの知見が少ないステークホルダーが多い環境で、要求された仕様から目的を読み解き、複数の仕様案を提示しながら開発を進めた。

### 正社員・インターン
#### チャットプラス株式会社 (2017年12月～2019年9月)
`会社規模` 約10人

`担当業務` API連携機能の実装、UI/UX改善、ユーザーサポート、障害調査

`使用技術` FuelPHP、JavaScript、AWS(EC2、RDS、S3、CloudFront、SES、SQS、Lambda)

`コメント` 2017年12月〜2019年3月は学生インターン、2019年4月〜9月は正社員として勤務。他社サービスとのAPI連携開発を中心に、法人営業、採用面接、インターン教育、展示会出展など幅広く担当した。顧客対応を通じて、ユーザーが迷いやすい箇所の特定や自己解決を促す仕組み作りなど、プロダクト改善の勘所を掴んだ。
...
`コメント` エンジニアの知人と共同創業した会社で、代表として活動。ヘッドレスフォームサービスの[HyperForm](https://hyperform.jp/)やファイルのウィルスチェックAPIサービスの[malcheck](https://malcheck.com/)など複数のサービスを運営している。

バックエンドやインフラの開発は共同創業者が中心に行い、自身は顧客対応、プレスリリース執筆、ユーザーインタビュー、外注管理、LP作成、管理画面のUX改善、協業先の開拓や競合調査などを担当。有料契約数は約140件。
